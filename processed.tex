...
Future versions of Coq are planned to support proof irrelevance: every \ensuremath{\Varid{p},\Varid{q:P:Prop}} are
...
% \begin{code}
% Record Monoid (A: Type) (R: A â A â Prop)
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{Record}\;\Conid{SemiGroup}\;(\Conid{A:}\;\Conid{Type})\;(\Varid{eq:}\;\Conid{A}\;\rightarrow\;\Conid{A}\;\rightarrow\;\Conid{Prop})\;{}\<[E]%
\\
\>[B]{}(\Varid{op:}\;\Conid{A}\;\rightarrow\;\Conid{A}\;\rightarrow\;\Conid{A})\;\mathbin{:}\;\Conid{Prop}\;\Conid{:=}\;\Varid{...}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{20}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{Lemma}\;\Varid{perm}\;\Conid{A}\;\Varid{eq}\;\Varid{op}\;(\Conid{P:}\;\Conid{SemiGroup}\;\Conid{A}\;\Varid{eq}\;\Varid{op})\;\Varid{x}\;\Varid{y}\;\Varid{z:}\;{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{Record}\;\Conid{SemiGroup}\;(\Conid{A:}\;\Conid{Type})\;(\Varid{eq:}\;\Conid{Equiv}\;\Conid{A})\;{}\<[E]%
\\
\>[B]{}\hsindent{18}{}\<[18]%
\>[18]{}(\Varid{op:}\;\Conid{SemiGroupOp}\;\Conid{A})\;\mathbin{:}\;\Conid{Prop}\;\Conid{:=}\;\Varid{...}{}\<[E]%
\\
\>[B]{}\mathbf{Lemma}\;\Varid{perm}\;\Conid{A}\;\Varid{eq}\;\Varid{op}\;(\Conid{P:}\;\Conid{SemiGroup}\;\Conid{A}\;\Varid{eq}\;\Varid{op})\;\Varid{x}\;\Varid{y}\;\Varid{z:}\;{}\<[E]%
\\
\>[B]{}\hsindent{18}{}\<[18]%
\>[18]{}\Varid{x}\;\Varid{\&}\;\Varid{y}\;\Varid{\&}\;\Varid{z}\;\mathrel{=}\;\Varid{z}\;\Varid{\&}\;\Varid{y}\;\Varid{\&}\;\Varid{x.}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
context. The context for \ensuremath{\Varid{perm}} looks like:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
these entities (like \ensuremath{\Varid{eq}} and \ensuremath{\Varid{op}} for \ensuremath{\Varid{perm}}) \emph{is} a bit of a chore. Fortunately, Coq
provides a feature called implicit generalization, which is exactly what we need.
With it, we can write \ensuremath{\Varid{perm}} as follows:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathbf{Lemma}\;\Varid{perm}\hspace*{0mm}`(\Conid{SemiGroup}\;\Conid{A})\;\Varid{x}\;\Varid{y}\;\Varid{z:}\;\Varid{x}\;\Varid{\&}\;\Varid{y}\;\Varid{\&}\;\Varid{z}\;\mathrel{=}\;\Varid{z}\;\Varid{\&}\;\Varid{y}\;\Varid{\&}\;\Varid{x.}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
The compatibility of the relation \ensuremath{\Varid{e}} can be stated in two provably  equivalent ways.
Directly, \ensuremath{\Varid{eAlgebra}\;\Conid{:=}\;\Varid{@Algebra}\;\Varid{et}\;\Varid{v}\;\Varid{e}\;\anonymous } or  indirectly, by stating that the relation
as a set of pairs is a subalgebra in the product algebra.
%theory/ua_congruence.v
% \begin{code}
%  eSub := @ua_subalgebraT.ClosedSubset et vv _ _ Q.
% \end{code}
...
\ColumnHook
\end{hscode}\resethooks
A congruence relation is coarser than the setoid relation, as indicated by the use of \ensuremath{\Conid{Proper}}
...
variables. The term algebra is initial. One may expect that this could be useful to
...
The product of two $\Sigma$-algebras is their categorical product.
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{Variable}\;\Varid{o:}\;\Varid{variety.Object}\;\Varid{theory.}{}\<[E]%
\\
\>[B]{}\mathbf{Global}\;\Conid{Instance:}\;\Conid{SemiGroupOp}\;(\Varid{o}\;\Varid{tt})\;\Conid{:=}\;\Varid{algebra\char95 op}\;\Varid{theory}\;\Varid{mult.}{}\<[E]%
\\
\>[B]{}\mathbf{Global}\;\Conid{Instance:}\;\Conid{MonoidUnit}\;(\Varid{o}\;\Varid{tt})\;\Conid{:=}\;\Varid{algebra\char95 op}\;\Varid{theory}\;\Varid{one.}{}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{Class}\;\Conid{Category}\;\Conid{O}\hspace*{0mm}`\hspace*{0mm}\{\Varid{!Arrows}\;\Conid{O}\mskip1.5mu\}\hspace*{0mm}`\hspace*{0mm}\{\Pi\;{}\<[36]%
\>[36]{}\Varid{x}\;\Varid{y:}\;\Conid{O},\Conid{Equiv}\;(\Varid{x}\;\Varid{â¶}\;\Varid{y})\mskip1.5mu\}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\hspace*{0mm}`\hspace*{0mm}\{\Varid{!CatId}\;\Conid{O}\mskip1.5mu\}\hspace*{0mm}`\hspace*{0mm}\{\Varid{!CatComp}\;\Conid{O}\mskip1.5mu\}\;\mathbin{:}\;\Conid{Prop}\;\Conid{:=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\hspace*{0mm}\{\Varid{arrow\char95 equiv:>}\;\Pi\;{}\<[22]%
\>[22]{}\Varid{x}\;\Varid{y:}\;\Conid{O},\Conid{Setoid}\;(\Varid{x}\;\Varid{â¶}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{comp\char95 proper:>}\;\Pi\;{}\<[22]%
\>[22]{}\Varid{x}\;\Varid{y}\;\Varid{z},{}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{comp\char95 assoc}\;(\Varid{w}\;\Varid{x}\;\Varid{y}\;\Varid{z:}\;\Conid{O})\;(\Varid{a:}\;\Varid{w}\;\Varid{â¶}\;\Varid{x})\;(\Varid{b:}\;\Varid{x}\;\Varid{â¶}\;\Varid{y})\;(\Varid{c:}\;\Varid{y}\;\Varid{â¶}\;\Varid{z})\;\mathbin{:}\;{}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}\Varid{c}\;\circ\;(\Varid{b}\;\circ\;\Varid{a})\;\mathrel{=}\;(\Varid{c}\;\circ\;\Varid{b})\;\circ\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{id\char95 l}\hspace*{0mm}`(\Varid{a:}\;\Varid{x}\;\Varid{â¶}\;\Varid{y})\;\mathbin{:}\;\Varid{cat\char95 id}\;\circ\;\Varid{a}\;\mathrel{=}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{id\char95 r}\hspace*{0mm}`(\Varid{a:}\;\Varid{x}\;\Varid{â¶}\;\Varid{y})\;\mathbin{:}\;\Varid{a}\;\circ\;\Varid{cat\char95 id}\;\mathrel{=}\;\Varid{a}\mskip1.5mu\}\;.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Where \ensuremath{\Varid{\%signature}}
tells Coq how to interpret \ensuremath{\Varid{equiv}}.\marginpar{Where is this defined?}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Conid{Context}\hspace*{0mm}`\hspace*{0mm}\{\Conid{Category}\;\Conid{C}\mskip1.5mu\}\hspace*{0mm}`\hspace*{0mm}\{\Conid{Category}\;\Conid{D}\mskip1.5mu\}{}\<[E]%
\\
\>[3]{}\hspace*{0mm}`\hspace*{0mm}\{\Varid{!Functor}\;(\Conid{F:}\;\Conid{C}\;\rightarrow\;\Conid{D})\;\Conid{Fa}\mskip1.5mu\}\hspace*{0mm}`\hspace*{0mm}\{\Varid{!Functor}\;(\Conid{G:}\;\Conid{C}\;\rightarrow\;\Conid{D})\;\Conid{Ga}\mskip1.5mu\}\;.{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\mathbf{Class}\;\Conid{NaturalTransformation}\;(\Conid{Î·:}\;\Pi\;{}\<[39]%
\>[39]{}\Varid{c},\Conid{F}\;\Varid{c}\;\Varid{â¶}\;\Conid{G}\;\Varid{c})\;\mathbin{:}\;\Conid{Prop}\;\Conid{:=}\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{natural:}\;\Pi\;{}\<[17]%
\>[17]{}(\Varid{x}\;\Varid{y:}\;\Conid{C})\;(\Varid{f:}\;\Varid{x}\;\Varid{â¶}\;\Varid{y}),\Conid{Î·}\;\Varid{y}\;\circ\;\Varid{fmap}\;\Conid{F}\;\Varid{f}\;\mathrel{=}\;\Varid{fmap}\;\Conid{G}\;\Varid{f}\;\circ\;\Conid{Î·}\;\Varid{x.}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ColumnHook
\end{hscode}\resethooks
This defines a monad on the category of \ensuremath{\Conid{Type}}s with extensional functions.\marginpar{Proof this
formally}.
...
assignment:\footnote{Categorically: \ensuremath{\mathbb{N}} is
an \ensuremath{\Conid{Expr}}-algebra and \ensuremath{\Varid{eval}} is \ensuremath{\Varid{map}\;\Varid{vars}} composed with the algebra map.}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\ensuremath{\Conid{Expr}}-algebra monad, behaves much like the tree monad. We now provide a direct definition of the
...
Given a heap and value, \ensuremath{\Conid{Lookup}} instances give the value's index in the heap:
% \marginpar{A
...
One useful operation we need before we get to Quote relates to variables and expression
 evaluation. As its name suggests, \ensuremath{\Varid{map\char95 var}} maps an expression's variable indices.
This reindexing function is the the \ensuremath{\Varid{map}} of the \ensuremath{\Conid{Expr}}-monad.
...
numbers in the following example \ensuremath{(\Conid{S}\;\Varid{x})\;= \;(\Conid{S}\;\Varid{y})}. In this case type classes provide superior proof
...
approach. The \ensuremath{\mathbf{Program}} machinery allows one to conveniently write programs with Hoare-style
pre-
and post-conditions. I.e.\ functions $f: \{ A \mid P \} \to \{ B \mid Q \}$. Both side conditions
are intended to be proof irrelevant, they are in \ensuremath{\Conid{Prop}}. Presently, Coq does not support such subset
types, thus forcing the user to manually prove that \ensuremath{\Varid{f}} does not depend on the proof of \ensuremath{\Conid{P}}.
