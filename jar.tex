...
Algebra flourishes by the interplay between syntax and semantics. The Prolog-like abilities of type class unification allow us to conveniently define a quote function thus facilitating the use of reflective techniques.\marginpar{Do TODOs}
  % todo: handle.
\end{abstract}
