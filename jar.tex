...
% note: we don't mention "super classes" because by Matthieu's terminology only parameters-of-class-type are "super classes", and for those that means only the operational classes, which we certainly don't think of as being part of the hierarchy.
