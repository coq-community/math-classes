...
% The concrete implementation we use are just the Peano naturals \lstinline|nat|. Showing that \lstinline|nat| with its arithmetic operations and Leibniz equality form a \lstinline|SemiRing| is entirely routine, as is defining a map to an arbitrary other semiring and showing that this map is unique as a \lstinline|SemiRing_Morphism|, so that we get initiality.

%integers all the same:
